...
app.use(cors({
  origin: ['http://localhost:8080', 'http://localhost:1234', 'https://sci-flix.netlify.app', 'http://localhost:4200', 'https://ambrosia-fish.github.io', 'https://sciflix-angular-clientfeztech.io'],
